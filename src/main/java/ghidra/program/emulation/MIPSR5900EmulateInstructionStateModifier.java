...
public class MIPSR5900EmulateInstructionStateModifier extends EmulateInstructionStateModifier {

	public MIPSR5900EmulateInstructionStateModifier(Emulate emu) {
		super(emu);
